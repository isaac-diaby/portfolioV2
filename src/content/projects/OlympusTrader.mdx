...
thumbnail: /images/olympusTrader.webp
description: Olympus Trader is trading bot framework that allows you to create your own trading strategies using python.
